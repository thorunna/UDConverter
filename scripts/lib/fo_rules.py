...
head_rules = {
    ...
    "IP-SMC": {
        "dir": "r",
        "rules": ["IP-INF-SBJ", "IP-SMC", "NP-PRD", "VAG-.", "ADJP", "NP.*"],
    },  # small clause
    "IP-SMC-SBJ": {
        "dir": "r",
        "rules": ["IP-INF-SBJ", "IP-SMC", "NP-PRD", "VAG-.", "ADJP", "NP.*"],
    ...
    "NP-PRN": {
        "dir": "r",
        "rules": ["N-.", "NS-.", "NPR-.", "NP", "NPRS-.", "PRO-.", "MAN-.", "OTHER-."],
    },  # appositive
    "NP-PRN-ELAB": {
        "dir": "r",
    ...
    "ADVP": {
        "dir": "r",
        "rules": ["N-.", "NS-.", "NPR-.", "NPRS-.", "ADV", "ADVR", "ADVS", "WADV"],
    },
    "ADVP-DIR": {
        "dir": "r",
...
relation_IP = {
    ...
    "INF-SPE-LFD": "acl",
    "INF-SPE-PRN": "acl",
    "INF-SPE-PRN-ELAB": "acl",  # same as INF-SPE-PRN
    "INF-SPE-PRP": "advcl",  # purpose
    "INF-SPE-PRP-PRN": "advcl",
    "INF-SPE-SBJ": "acl",
    "INF-PRN": "acl",
    "INF-PRN-ELAB": "acl",
    "INF-PRN-PRP": "advcl",  # infinitive-purpose
    "INF-PRN-SPE": "acl",
