...
head_rules = {
            ...
            'IP-MAT-SPE'    : {'dir':'r', 'rules':['VB', 'VB.*', 'VAN', 'RD.*', 'DO.*', 'DAN', 'VP', 'ADJP', 'NP', 'VAN', 'VAG', 'NP-PRD', 'N.*', 'IP-SMC', 'IP-MAT.*']},
            ...
            'IP-SUB-SPE'    : {'dir':'r', 'rules':['VB.*', 'HV.*', 'VAN', '.*AG', 'IP-SUB-SPE', 'DO.*',]},
            ...
            'QTP'           : {'dir':'r', 'rules':['IP.*', 'NP.*', 'ADVP', 'N.*', 'QTP']},      #quote phrase
