...
head_rules = {
            'IP-INF'        : {'dir':'r', 'rules':['VB', 'DO', 'VAN', 'IP-INF', 'ADJP']},
            ...
            'IP-MAT'        : {'dir':'r', 'rules':['VB', 'VB.*','VAN', 'RD.*', 'DO.*', 'DAN', 'HV.*', 'VAG', 'DAG', 'HAG', 'VP', 'IP-MAT-\d', 'MD.*', 'PP', 'ADJP', 'RP', 'NP-PRD', 'NP-SBJ', 'NP', 'N.*', 'IP-SMC', 'IP-MAT', 'IP-MAT-*', '.+[^PUNCT]']},
            ...
            'IP-MAT-SPE'    : {'dir':'r', 'rules':['VB', 'VB.*', 'VAN', 'RD.*', 'DO.*', 'IP-MAT.*', 'IP-MAT-PRN', 'DAN', 'VP', 'HV.*', 'ADJP', 'ADVP', 'NP', 'VAN', 'VAG', 'NP-PRD', 'N.*', 'IP-SMC', 'IP-MAT.*', '.+[^PUNCT]']},
            ...
            'IP-SUB'        : {'dir':'r', 'rules':['PP-BY', 'VP', 'VB', 'VB.*', 'DO.*', 'VAN', 'RD.*', 'DAN', 'RAN', 'HAN', 'BAN', 'VAG', 'RAG', 'HAG', 'BAG', 'RDN', 'BEN', 'HVN', 'HV.*', 'MD.*', 'IP-INF.*', 'ADJP', 'NP-PRD', 'PP-BY', 'NP.*', 'RD.*', 'ADVP', 'IP-SUB']},
            ...
            'IP-SUB-SPE'    : {'dir':'r', 'rules':['VB.*', 'HV.*', 'VAN', 'DAN', '.*AG', 'IP-SUB-SPE', 'DO.*', 'CP-ADV-SPE']},
#            'IP-SUB-SPE=1'  : {'dir':'r', 'rules':['CP-ADV-SPE']},
            ...
            'CP-QUE-SPE'    : {'dir':'r', 'rules':['IP-SUB.*', 'IP-MAT.*']},
            ...
            'NP'            : {'dir':'r', 'rules':['CP-FRL', 'N-.*|NS-.*|FW', 'NPR-.*|NPRS-.', 'N.*', 'RRC', 'PRO-.', 'MAN-.', 'NP.*', 'Q.*', 'OTHER-.']},
            ...
            'NP-PRN'        : {'dir':'r', 'rules':['N-.', 'NS-.', 'NPR[S]-.', 'NP', 'NPRS-.', 'PRO-.', 'MAN-.', 'OTHER-.']},   #viðurlag, appositive
            ...
            #'NP-OB1'        : {'dir':'r', 'rules':['N-.', 'NS-.', 'NPR-.', 'NPRS-.', 'NS-.', 'NP', 'NP-.+', 'PRO-.', 'ONE+Q-A', 'MAN-A', 'OTHER-.']},
            ...
            'NP-PRD'        : {'dir':'r', 'rules':['N.*|FW', 'NS.*', 'NP.*', 'PRO.*' 'OTHER-.', 'NUMP']},     #sagnfylling copulu
            'NP-SPR'        : {'dir':'r', 'rules':['N-.', 'NS-.', 'NPR-.' 'NPRS-.',]},   #secondary predicate
            'NP-POS'        : {'dir':'r', 'rules':['N.*', 'NPR-.', 'N-.', 'NS-.', 'NPRS-.', 'PRO-.', 'NP', 'NP-.+', 'MAN-.', 'OTHER-.']},
            ...
            'PP'            : {'dir':'r', 'rules':['CP-FRL', 'N-.', 'NS-.', 'NPR-.', 'NPRS-.', 'NP', 'NP-.+', 'FS', 'CP-ADV.*', 'IP-SMC', 'ADVP', 'ADJP', 'CP-.*|PP', 'IP-INF.*', 'IP-PPL', 'P', 'PP']},
            ...
            'CONJP'         : {'dir':'r', 'rules':['IP-INF-SPE', 'IP-MAT-SPE', 'IP-MAT-SPE=1', 'IP-SUB', 'IP-SUB=5', 'IP-SUB=2', 'N-.', 'NS-.', 'NPR-.', 'NPRS-.', 'NP.*', 'NX', 'NUMP.*', 'NUM-.', 'QTP', 'QP', 'QX', 'IP-SUB', 'IP-MAT.*', 'IP-INF', 'IP-INF.*', 'IP-.+', 'CP-QUE', 'ADJP', 'ADJX', 'ADVP.*', 'PP', 'RRC', 'CONJ']},
            ...
            'QTP'           : {'dir':'r', 'rules':['IP.*', 'NP.*', 'VAN', 'ADVP', 'N.*', 'QTP', 'PP', 'WNP', '.+[^PUNCT]']},      #quote phrase
