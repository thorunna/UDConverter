...
head_rules = {
            ...
            'IP-SUB-SPE'    : {'dir':'r', 'rules':['VB.*', 'HV.*', 'VAN', 'DAN', '.*AG', 'IP-SUB-SPE', 'DO.*']},
            ...
            'NP'            : {'dir':'r', 'rules':['CP-FRL', 'N.*|FW', 'NPRS-.', 'N.*', 'RRC', 'PRO-.', 'MAN-.', 'NP.*', 'Q.*', 'OTHER-.']},
            ...
            'NP-SBJ'        : {'dir':'r', 'rules':['N-.*|FW|NS-.*[^NP-POS]', 'NPR-N', 'NPRS-N', 'MAN.*', 'PRO-.', 'NP.*', 'ADJ-N', 'OTHER-.', 'Q', 'IP-MAT-PRN']},
